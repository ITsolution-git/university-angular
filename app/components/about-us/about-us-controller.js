...
unipaper.controller('aboutUsController', function($scope, contentful, environmentVariables, $rootScope, utilityFactory, $window) {
  ...
  var fillMetaTags = function() {
    $rootScope.metaTags = {
      title: "About Us - The University Paper",
    };
  };
